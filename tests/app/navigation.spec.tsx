...
describe('Sidebar Navigation', () => {
  test('should render all navigation links with the correct href attributes', () => {
    ...
    allLinks.forEach(link => {
      const linkElement = screen.getByText((en as Record<string, string>)[link.label] || link.label);
      // The link element is the parent of the text
      const parentAnchor = linkElement.closest('a');
